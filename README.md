...
Card abilities are **partly** implemented: **18 of the starter deck's 28 printed ability clauses,
across 14 of its 19 cards**. Every unimplemented clause plays as if its text box were blank, and the
